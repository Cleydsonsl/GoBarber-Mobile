...
<h3 align="center">
  React Native Aplicativo para o projeto GoBarber
</h3>

<p align="center">
  <a href="#%EF%B8%8F-sobre">Sobre o Projeto</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
...
- Tenha a [API](https://github.com/CleydsonSl/gobarber-api) deste aplicativo em execução

**Clone o projeto e acesse a pasta**

```bash
$ git clone https://github.com/CleydsonSl/gobarber-mobile.git && cd gobarber-mobile
```
